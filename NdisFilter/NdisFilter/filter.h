...
extern FILTER_LOCK         glMacMutex;

#define FILTER_FRIENDLY_NAME        L"NdisFilter NDIS LightWeight Filter"
#define FILTER_UNIQUE_NAME          L"{416f1526-1613-483e-ab6f-18ea3c7b72cf}" //unique name, quid name
#define FILTER_SERVICE_NAME         L"NdisFilter"

//
// The filter needs to handle IOCTLs
//
#define LINKNAME_STRING             L"\\??\\NdisFilter"
