...
extern NDIS_SPIN_LOCK         glMacMutex;

extern PUCHAR glServerMac;
extern PUCHAR glSrcMac;
extern PUCHAR glSrcIP;
extern PUCHAR glServerIP;
extern PUCHAR glGatewayIP;
extern BOOLEAN glIsConfigSet;
